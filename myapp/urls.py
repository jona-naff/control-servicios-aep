...
urlpatterns = [
    ...
    path('servicios/avaluos/generar_pdf/<int:cliente_id>/<int:tipo_id>/<int:valuador_id>/<int:estatus_id>/<int:estadoid>/<int:coloniaid>',views.generar_pdf,name="generar_pdf"),
