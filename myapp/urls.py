...
urlpatterns = [
    ...
    path("servicios/avaluos/<str:dtsolicitud_inicial>/<str:dtsolicitud_final>/<str:dtvaluador_inicial>/<str:dtvaluador_final>", views.get_avaluos_bydate, name="get_avaluos_inic"),
