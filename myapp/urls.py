...
urlpatterns = [
    ...
    path('servicios/avaluos/generar_pdf/<int:cliente_id>/<int:tipo_id>/<int:valuador_id>/<int:estatus_id>/<int:estado_id>/<int:municipio_id>/<int:colonia_id>',views.GeneratePDFView.as_view(),name="GeneratePDFView"),
    path("servicios/avaluos/generar_excel/<int:cliente_id>/<int:tipo_id>/<int:valuador_id>/<int:estatus_id>/<int:estado_id>/<int:municipio_id>/<int:colonia_id>", views.generar_excel, name="generar_excel"),
