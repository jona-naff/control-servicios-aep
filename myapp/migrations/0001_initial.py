...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name="Colonias",
            fields=[
                ("coloniaid", models.IntegerField(primary_key=True, serialize=False)),
                ("municipioid", models.IntegerField()),
                ("nombre", models.CharField(max_length=250)),
            ],
            options={"db_table": "colonias", "managed": False,},
        ),
        migrations.CreateModel(
            name="Estados",
            fields=[
            ...
            options={"db_table": "estados", "managed": False,},
        ),
        migrations.CreateModel(
            name="Municipios",
            fields=[
            ...
            options={"db_table": "municipios", "managed": False,},
        ),
        migrations.CreateModel(
            name="Clientes",
            fields=[
            ...
            options={"db_table": "clientes", "managed": True,},
        ),
        migrations.CreateModel(
            name="Estatus",
            fields=[
            ...
            options={"db_table": "estatus", "managed": True,},
        ),
        migrations.CreateModel(
            name="Tipos",
            fields=[
            ...
            options={"db_table": "tipos", "managed": True,},
        ),
        migrations.CreateModel(
            name="Valuadores",
            fields=[
            ...
            options={"db_table": "valuadores", "managed": True,},
        ),
        migrations.CreateModel(
            name="Avaluos",
            fields=[
                ...
                (
                    "cliente",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="myapp.clientes"
                    ),
                ),
                (
                    "estatus",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="myapp.estatus"
                    ),
                ),
                (
                    "tipo",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="myapp.tipos"
                    ),
                ),
                (
                    "valuador",
            ...
            options={"db_table": "avaluos", "managed": True,},
        ),
    ]
