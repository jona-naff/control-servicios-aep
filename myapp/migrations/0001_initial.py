...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Colonias',
            fields=[
                ('colonia_id', models.IntegerField(blank=True, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_dictamen', models.CharField(blank=True, max_length=100)),
                ...
                ('tipoimb', models.ForeignKey(default='80', on_delete=django.db.models.deletion.CASCADE, to='myapp.tiposimb')),
